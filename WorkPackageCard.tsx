  ...
  useEffect(() => {
    if (isOpen) {
      if (initialTask) {
        ...
        setIsOTD(initialTask.isOTD || false);
      ...
      <div className="bg-white rounded-xl shadow-2xl w-full max-w-lg mx-4 overflow-hidden animate-in fade-in zoom-in duration-200 flex flex-col max-h-[90vh]">
        ...
        <form onSubmit={handleSubmit} className="p-4 space-y-5 overflow-y-auto">
          ...
          <div className="flex items-center gap-3 bg-slate-50 p-3 rounded-lg border border-slate-200">
            ...
            />
            <label htmlFor="isOTD" className="text-sm font-medium text-slate-700 cursor-pointer select-none">
              On-Time Delivery (OTD)
              <span className="block text-[10px] text-slate-500 font-normal">Highlighted in light blue with OTD indicator</span>
            </label>
          </div>
